fx = {
	...
	property_04 = {name = "FX5", type = "VARTYPE_STRING", value = ""},--frigate_smoke_thrower
	property_03 = {name = "FX4", type = "VARTYPE_STRING", value = "frigate_smoke_beam"},
	property_00 = {name = "Fx1", type = "VARTYPE_STRING", value = "frigate_flare_beam"},},}
