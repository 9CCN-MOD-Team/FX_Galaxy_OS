...
--  { 138, "MainUI_UserEvent( eRallyPoint)",		 										INKE_KeyDown, 0, 	"   $5424", 		{ PKEY } },
    ...
    { 165, "OutputCameraInformation()",									INKE_KeyDown, 0,	"$5586", { CONTROLKEY, F1KEY } },
    ...
    --{ 171, eKamikaze,													INKE_KeyDown, 0,	"$5307", { CONTROLKEY, SHIFTKEY, KKEY } },		-- Kamikaze
		...
		{ 175, "UI_SetElementVisible('NewTaskbar', 'ShowMusicMenu', 1)",					INKE_KeyDown, 0, "$90111", { F1KEY } },		-- Music Player
		{ 176, "UI_SetElementVisible('NewTaskbar', 'CallCouncilor', 1)",					INKE_KeyDown, 0, "$90070", { F9KEY } },		-- Councilor
    ...
    { 181, "MainUI_ScarEvent('Camera_TrackSelected()')",				INKE_KeyDown, 0,	"$90122", { SHIFTKEY, EKEY } },
    { 182, "Camera_PanCmd(INKE_KeyDown,PS_Up)",							INKE_KeyDown, 0,	"$5436", { ALTKEY, WKEY  }},
    { 183, "Camera_PanCmd(INKE_KeyUp,PS_Up)"    ,						INKE_KeyUp, 0,		"$5436", { ALTKEY, WKEY  }},
    { 184, "Camera_PanCmd(INKE_KeyDown,PS_Down)",						INKE_KeyDown, 0,	"$5437", { ALTKEY, SKEY  }},
    { 185, "Camera_PanCmd(INKE_KeyUp,PS_Down)"    ,						INKE_KeyUp, 0,		"$5437", { ALTKEY, SKEY  }},
    { 186, "Camera_PanCmd(INKE_KeyDown,PS_Left)",						INKE_KeyDown, 0,	"$5438", { ALTKEY, AKEY  }},
    { 187, "Camera_PanCmd(INKE_KeyUp,PS_Left)"    ,						INKE_KeyUp,   0,	"$5438", { ALTKEY, AKEY  }},
    { 188, "Camera_PanCmd(INKE_KeyDown,PS_Right)",						INKE_KeyDown, 0,	"$5439", { ALTKEY, DKEY  }},
    { 189, "Camera_PanCmd(INKE_KeyUp,PS_Right)"    ,					INKE_KeyUp,   0,	"$5439", { ALTKEY, DKEY  }},
    { 190, "Camera_PanCmd(INKE_KeyDown,PS_ModUp)",						INKE_KeyDown, 0,	"$5440", { ALTKEY, QKEY  }},
    { 191, "Camera_PanCmd(INKE_KeyUp,PS_ModUp)"    ,					INKE_KeyUp,   0,	"$5440", { ALTKEY, QKEY  }},
    { 192, "Camera_PanCmd(INKE_KeyDown,PS_ModDown)",					INKE_KeyDown, 0,	"$5441", { ALTKEY, EKEY  }},
    { 193, "Camera_PanCmd(INKE_KeyUp,PS_ModDown)"    ,					INKE_KeyUp,   0,	"$5441", { ALTKEY, EKEY  }},
    { 194, "MainUI_ScarEvent('Camera_RotateBegin(-1)')"    ,			INKE_KeyDown,   0,	"$5441", { SHIFTKEY, AKEY  }},
    ...
    { 200, [[MainUI_ScarEvent("Camera_ForwardInit()")]]    ,			INKE_KeyDown,   0,	"$90124", { SHIFTKEY, XKEY  }},
}
