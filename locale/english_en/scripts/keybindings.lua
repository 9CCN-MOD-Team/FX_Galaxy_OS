...
--  { 138, "MainUI_UserEvent( eRallyPoint)",		 										INKE_KeyDown, 0, 	"   $5424", 		{ PKEY } },
    ...
    { 182, "Camera_PanCmd(INKE_KeyDown,PS_Up)",							INKE_KeyDown, 0,	"$5436", { SHIFTKEY, WKEY  }},
    { 183, "Camera_PanCmd(INKE_KeyUp,PS_Up)"    ,						INKE_KeyUp, 0,		"$5436", { SHIFTKEY, WKEY  }},
    { 184, "Camera_PanCmd(INKE_KeyDown,PS_Down)",						INKE_KeyDown, 0,	"$5437", { SHIFTKEY, SKEY  }},
    { 185, "Camera_PanCmd(INKE_KeyUp,PS_Down)"    ,						INKE_KeyUp, 0,		"$5437", { SHIFTKEY, SKEY  }},
    { 186, "Camera_PanCmd(INKE_KeyDown,PS_Left)",						INKE_KeyDown, 0,	"$5438", { SHIFTKEY, AKEY  }},
    { 187, "Camera_PanCmd(INKE_KeyUp,PS_Left)"    ,						INKE_KeyUp,   0,	"$5438", { SHIFTKEY, AKEY  }},
    { 188, "Camera_PanCmd(INKE_KeyDown,PS_Right)",						INKE_KeyDown, 0,	"$5439", { SHIFTKEY, DKEY  }},
    { 189, "Camera_PanCmd(INKE_KeyUp,PS_Right)"    ,					INKE_KeyUp,   0,	"$5439", { SHIFTKEY, DKEY  }},
    { 190, "Camera_PanCmd(INKE_KeyDown,PS_ModUp)",						INKE_KeyDown, 0,	"$5440", { SHIFTKEY, QKEY  }},
    { 191, "Camera_PanCmd(INKE_KeyUp,PS_ModUp)"    ,					INKE_KeyUp,   0,	"$5440", { SHIFTKEY, QKEY  }},
    { 192, "Camera_PanCmd(INKE_KeyDown,PS_ModDown)",					INKE_KeyDown, 0,	"$5441", { SHIFTKEY, EKEY  }},
    { 193, "Camera_PanCmd(INKE_KeyUp,PS_ModDown)"    ,					INKE_KeyUp,   0,	"$5441", { SHIFTKEY, EKEY  }},
