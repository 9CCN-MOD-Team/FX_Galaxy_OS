...
dofilepath("Data:leveldata\\campaign\\tutorial\\RPG\\script\\trademenudata.lua")
...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	DTM004[15],	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1_Alert_Chipped",	 [[UI_SetElementVisible('GateMenu1','Accept',1);]]),
					NewMenuButton("m_btnCancel",	DTM004[16],	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[UI_SetElementVisible('GateMenu1','Cancel',1);]]),
