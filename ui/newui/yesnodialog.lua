...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	"$5172",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1_Alert_Chipped",	 [[if MainUI_ScarEvent~=nil then MainUI_ScarEvent("rawset(globals(),'DTM4_Cancel',nil) if DTM4_Accept~=nil then DTM4_Accept() rawset(globals(),'DTM4_Accept',nil) end") end;UI_DialogAccept();]]),
					NewMenuButton("m_btnCancel",	"$5171",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[if MainUI_ScarEvent~=nil then MainUI_ScarEvent("rawset(globals(),'DTM4_Accept',nil) if DTM4_Cancel~=nil then DTM4_Cancel() rawset(globals(),'DTM4_Cancel',nil) end") end;UI_DialogCancel();]]),
