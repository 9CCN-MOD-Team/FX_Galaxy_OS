...
NewResearchMenu = {
	...
	FamilyIcons = {
				...
				{"Vaygr", "Platform","Vgr_C_Module_PlatformControl"},
				...
				{"Hiigaran", "Platform","Vgr_C_Module_PlatformControl"},
				{"Hiigaran", "Utility","Vgr_Probe_ECM"},
				--{"Hiigaran", "SubSystemModule",""},
				--{"Hiigaran", "SubSystemSensors",""},
----------------------------------------------------------------------
        {"Keeper", "Fighter", "kpr_bomber"}, 
        {"Keeper", "Corvette", "kpr_Mover"}, 
        {"Keeper", "Frigate", "kpr_destroyer1"},
        {"Keeper", "Capital", "kpr_Dreadnaught"}, 
        {"Keeper", "Platform", "kpr_energy_photonBomb"}, 
----------------------------------------------------------------------
        {"Kadesh", "Fighter", "Kad_Swarmer"}, 
        {"Kadesh", "Corvette", "kad_Variationswarmer"}, 
        {"Kadesh", "Frigate", "kad_militaryfuelpod"}, 
        {"Kadesh", "Capital","Kad_mothership"}, 
        {"Kadesh", "Platform", "kad_gunturret"}, 
----------------------------------------------------------------------
        {"Turanic", "Fighter", "tur_ac_Fighter"}, 
        {"Turanic", "Corvette", "tur_standardcorvette"}, 
        {"Turanic", "Frigate", "tur_vulcanfrigate"}, 
        {"Turanic", "Capital","tur_carrier"}, 
        {"Turanic", "Platform", "tur_ac_PlatformControl"}, 
        {"Turanic", "Utility","tur_resourcecollector"},
----------------------------------------------------------------------
        {"Taiidan", "Fighter", "TAI_Interceptor"}, 
        {"Taiidan", "Corvette", "TAI_lightcorvette"}, 
        {"Taiidan", "Frigate", "TAI_supportfrigate"}, 
        {"Taiidan", "Capital","TAI_mothership"}, 
        {"Taiidan", "Platform", "TAI_researchship"}, 
        {"Taiidan", "Utility","TAI_ResourceCollector"},
----------------------------------------------------------------------
        {"Bentusi", "Fighter", "tur_ac_Fighter"}, 
        {"Bentusi", "Corvette", "tur_ac_Corvette"}, 
        {"Bentusi", "Frigate", "tur_ac_Frigate"}, 
        {"Bentusi", "Capital","tur_as_CapShip"}, 
        {"Bentusi", "Platform", "tur_ac_PlatformControl"}, 
----------------------------------------------------------------------
