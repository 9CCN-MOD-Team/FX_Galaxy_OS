...
----------------------- Title Text Row -----------------------			
		{
			...
			
			{
				...
				;
				{
					...
					;
					NewMenuButton("m_btnAccept",	"$5172",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1_Alert_Chipped",	 [[
															UI_SetElementVisible('ModMenu','Yes', 1)
															UI_SetButtonPressed( 'NewTaskbar', 'btnMods', 0)
														 ]]),
					NewMenuButton("m_btnCancel",	"$5171",	"",	0,	BTN_FOOTER_SMALL_LAYOUT,	"FEButtonStyle1",	[[
															UI_SetElementVisible('ModMenu','No', 1)
															UI_SetButtonPressed( 'NewTaskbar', 'btnMods', 0)
