...
CustomCommandDefinitions =
{
    ...
    },
    {
        ...
        activateButtonName = "btnSwitch",
        rightClickDisplayName = "$90100",
    },
    {
        commandID = INFO_CustomStart + 5,
        activateButtonName = "btnDeliver",
        rightClickDisplayName = "$90101",
    },
    {
        commandID = INFO_CustomStart + 6,
        activateButtonName = "btnRelease",
        rightClickDisplayName = "$90105",
    },
    ...
    },		
    {
        ...
        activateButtonName = "btnTrack",
        rightClickDisplayName = "$90126",
    },
    {
