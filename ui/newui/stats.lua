...
Stats = {
	...
	onShow = [[
	  dofilepath("player:FX_TacticalReport_Enabled.lua")
	  if FX_TacticalReport_Enabled then 
	    UI_SetElementVisible("Stats", "btnMainMenu", 0)
	    UI_SetElementVisible("Stats", "btnBack", 0)
	    UI_SetElementVisible("Stats", "btnNextPage", 1)
	  else 
	    UI_SetElementVisible("Stats", "btnMainMenu", 1)
	    UI_SetElementVisible("Stats", "btnBack", 1)
	    UI_SetElementVisible("Stats", "btnNextPage", 0)
	  end
	]],
	...
	arrangeweight=1,
		...
		------------------------------------------------------------------------------------
		{
			...
			;		
				...
				NewMenuButton("btnNextPage",	"$2730",	"$90088",	0,	BTN_FOOTER_YES_LAYOUT,	"FEButtonStyle1_Alert_Outlined_Chipped",	"UI_ReloadScreen(\"TacticalReport\");UI_ShowScreen(\"TacticalReport\", eTransition)"),	
		},		
