...
BTN_NEXTTUTORIAL		= NewMenuButton("m_btnNextTutorial",	"$90004",	"$90005",	0,	LAYOUT_BUTTONS,	nil,	"FE_NextTutorial()")
BTN_RESTARTTUTORIAL		= NewMenuButton("m_btnRestartTutorial",	"$90006",	"$90007",	0,	LAYOUT_BUTTONS,	nil,	"FE_RestartGame(1)")
BTN_RESTARTTUTORIAL2	= NewMenuButton("m_btnRestartTutorial2","$90114",	"$90115",	0,	LAYOUT_BUTTONS,	nil,	"FE_RestartGame(1)")
BTN_RESTARTTUTORIAL3	= NewMenuButton("m_btnRestartTutorial3","$90116",	"$90117",	0,	LAYOUT_BUTTONS,	nil,	"MainUI_ScarEvent('DTM4_ReturnToPrevious()')")
BTN_RESTARTTUTORIAL4	= NewMenuButton("m_btnRestartTutorial4","$90118",	"$90119",	0,	LAYOUT_BUTTONS,	nil,	"MainUI_ScarEvent('DTM4_RestartRPG()')")
...
BTN_RESTARTTUTORIAL2.visible=0
BTN_RESTARTTUTORIAL3.visible=0
BTN_RESTARTTUTORIAL4.visible=0
...
---------------------------------------------------------------------------------------------
	{
		...
		BTN_NEXTTUTORIAL,
		BTN_RESTARTTUTORIAL,
		BTN_RESTARTTUTORIAL2,
		BTN_RESTARTTUTORIAL3,
		BTN_RESTARTTUTORIAL4,
		BTN_OPTIONS,
		BTN_EXITTOMAINMENU,
		BTN_EXITTOWINDOWS,
