...
dofilepath("data:ui/newui/newtaskbarAddon.lua")

--dofilepath("Data:/UI/NewUI/MusicPlayerUI.lua")
dofilepath("Data:/leveldata/campaign/tutorial/RPG/script/trademenudata_taskbar.lua")
dofilepath("Data:/UI/NewUI/TellTaleUI.lua")
