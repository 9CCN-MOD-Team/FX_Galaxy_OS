...
dofilepath("data:leveldata/campaign/Tutorial/RPG/script/dtm4_ping.lua")
dofilepath("data:leveldata/multiplayer/resdata/XPing.lua")
dofilepath("data:leveldata/campaign/fx_spfleet/lf_pings.lua")