...
Ship = {
	battleTimeOutTime				= 3,				-- Don't tweak this if you don't know what you are doing. takes 3 seconds to say that you're not in a battle anymore, while you are in battle you can't be cloaked, you are also visible always to the player you are firing at
...
MultiplierCap = {
    ...
    CloakDetection = 4.0,
    VisualRange = 6,
    PrimarySensorsRange = 2000,
    SecondarySensorsRange = 2000,
