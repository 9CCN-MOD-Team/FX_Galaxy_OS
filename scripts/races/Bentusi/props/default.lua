...
Number_Properties = {
	...
	persona_class_demand_corvette = 0.0,
...
SelfRace_ScriptsPath = "data:scripts/races/Bentusi/scripts/"
...
String_Properties = {
	...
	def_type_mothership = "ben_bentus",
	def_type_carrier = "ben_floatingcity",
	def_type_scout = "ben_fighter",
}
