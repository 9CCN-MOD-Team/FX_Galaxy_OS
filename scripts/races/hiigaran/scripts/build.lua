...
build = {
  ...
  {
    Type = SubSystem,
    ThingToBuild = "Hgn_LBC_HeavyTurret_F",
    RequiredResearch = "",
    RequiredFleetSubSystems = "AdvancedCapShipProduction",
    DisplayPriority = 2,
    DisplayedName = "$8116",
...
--  },
  ...
  },
  {
	...
	},
	{
  	...
  	RequiredResearch = "",
  	RequiredFleetSubSystems = "FrigateProduction & Research & (! AdvancedResearch)",
  	DisplayPriority = 10,
  	DisplayedName = "$7012",
  	Description = "$7013",
	},
