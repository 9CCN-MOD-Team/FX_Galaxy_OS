...
PopDecay = 0.01
	...
	SpacingRange = 	 { 75, 1.45, 150, 2.5 }
	SpacingRangeAg = { 75, 1.45, 150, 2.5 }
	SpacingRangeEv = { 75, 2.0,  150, 2.5 }
...
strikegroup =
{
	...
	{
		{
			OffsetFromParent 		= {-0.9499,-0.15,0},
			Children =
			{
				{
					Name = "ArmL",
					OffsetFromParent 		= {-0.95,0.16,0},
					Children =
					{
						{
							OffsetFromParent 		= {-0.95,0.14,0},
							Children =
							{
								{
									OffsetFromParent 		= {-0.95,-0.16,0},
