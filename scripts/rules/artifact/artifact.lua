...
dofilepath("data:leveldata/multiplayer/lib/artifact.lua")
...
function TreasureHunter()
	local sNum=Get_FX_Achievements_Value("TreasureHunter")
	if(sNum<20)then
		Set_FX_Achievements_Value("TreasureHunter",sNum+1)
	end
end
