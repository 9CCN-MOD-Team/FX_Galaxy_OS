...
--FXG Deathmatch Lib File
dofilepath("data:leveldata/multiplayer/lib/FXGDeathmatch.lua")
----
dofilepath("data:scripts/debug.lua")
--加载公共规则
dofilepath("data:scripts/rules/common.rule")
--加载随机地图列表获取代码
dofilepath("data:leveldata/multiplayer/fxrandom/randommap_scanmaps.lua")
...
--X system entrance
		XInit("reslist.lua", "X_FXGDeathmatch.lua")
--MusicPlayer Perset Function
		MusicPlayer_Oninit(music_data_original, 0, 3)
		Rule_Add("ShowMusicMenu")
--------
--FXG Deathmatch Function
		FXG_DeathmatchInit()--Rule_AddInterval("FXG_DeathmatchInit",10)
--Achievements
		FX_Achievements_Init("FXGDM")
------
