...
//	reflStrength+=1;
	...
	float diffStrength = max(0.0, 1.0-(specStrength+(mapGlowMask*extGlowPower)));//默认混合，剩下的是Diff
	diffStrength = max(0.0, 1.0-(0.3*specStrength+mapGlowMask*extGlowPower));//不与Spec混合
