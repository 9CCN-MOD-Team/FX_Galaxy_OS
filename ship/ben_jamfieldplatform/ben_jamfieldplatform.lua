...
function Create_ben_jamfieldplatform(CustomGroup, playerIndex, shipID)	
end

function Update_ben_jamfieldplatform(CustomGroup, playerIndex, shipID)	
...
function Destroy_ben_jamfieldplatform(CustomGroup, playerIndex, shipID)	
end