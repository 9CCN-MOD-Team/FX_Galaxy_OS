...
--dofilepath("data:leveldata/multiplayer/resdata/CustomCode.lua")
...
function Create_DroneFrigate(CustomGroup, playerIndex, shipID)
	...
	--Create_X(CustomGroup, playerIndex, shipID)
end
...
function Update_DroneFrigate(CustomGroup, playerIndex, shipID)
	...
	--Update_X(CustomGroup, playerIndex, shipID)
end
...
function Destroy_DroneFrigate(CustomGroup, playerIndex, shipID)	
	...
	--Destroy_X(CustomGroup, playerIndex, shipID)
end
