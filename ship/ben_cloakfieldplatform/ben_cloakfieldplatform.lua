...
function Create_ben_cloakfieldplatform(CustomGroup, playerIndex, shipID)	
end

function Update_ben_cloakfieldplatform(CustomGroup, playerIndex, shipID)	
...
function Destroy_ben_cloakfieldplatform(CustomGroup, playerIndex, shipID)	
end