...
function ChatterMisc(shipnm,parm2,code)
	...
	if (code==CD_MissileIncoming and shiptype==Capital) then -- only if the victim is a Capital ship
		...
		if (parm2=="Hgn_TorpedoFrigate" or parm2=="Hgn_TorpedoFrigateElite" or parm2=="Hgn_Destroyer" or parm2=="Kus_MissileDestroyer" or parm2=="Tur_TorpedoCorvette") then
...
function ChatterMiscHighPriority(shipnm,parm2,code)
	...
	elseif(code==CD_EnemyCaptureStarted) then
		...
		elseif (strupper(genericshipnm)=="DESTROYER")or(strupper(genericshipnm)=="MISSILEDESTROYER")or(strupper(genericshipnm)=="DESTROYER1")or(strupper(genericshipnm)=="GUARDIANSPIRIT") then
			playSpeechActor("STATUS_EnemyMarineFrigateAttack_Destroyer_1",raceHelper(),0, Frequency_Command)
		elseif (strupper(genericshipnm)=="BATTLECRUISER")or(strupper(genericshipnm)=="HEAVYCRUISER")or(strupper(genericshipnm)=="BATTLESHIP") then
			playSpeechActor("STATUS_EnemyMarineFrigateAttack_Battlecruiser_1",raceHelper(),0, Frequency_Command)
		elseif (strupper(genericshipnm)=="MOTHERSHIP")or(strupper(genericshipnm)=="MOTHERSHIPDARK")or(strupper(genericshipnm)=="MOTHERSHIPLIGHT")or(strupper(genericshipnm)=="BALCORAGATE") then
			playSpeechActor("STATUS_EnemyMarineFrigateAttack_Mothership_1",raceHelper(),0, Frequency_Command)
		elseif (strupper(genericshipnm)=="SHIPYARD") then
			playSpeechActor("STATUS_EnemyMarineFrigateAttack_Shipyard_1",raceHelper(),0, Frequency_Command)
		elseif (strupper(genericshipnm)=="DREADNAUGHT") then
	...
	elseif(code==CD_ShipArrived and genericshipnm=="Probe")or(strlower(genericshipnm)=="sensorarray") then
	...
	elseif(code==CD_ShipArrived and genericshipnm=="HSInhibitor")or(strlower(genericshipnm)=="gravwellgenerator") then
...
attackMap["Kus_ResourceController"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Kus_ResourceRefinery"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Kus_RepairCarrier"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Kus_Interceptor"] = {"STATUS_Int_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kus_AttackBomber"] = {"STATUS_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kus_LightCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kus_HeavyCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kus_MultiGunCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kus_CommandCorvette"] = {"STATUS_COMMANDCorvette_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Kus_IonCannonFrigate"] = {"STATUS_IonFrigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Kus_SupportFrigate"] = {"STATUS_SupportFrigate_Under_Attack", NameSupportPilot,NumSupportPilots}
attackMap["Kus_Destroyer"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Kus_MissileDestroyer"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Kus_HeavyCruiser"] = {"STATUS_Battlecruiser_Attack", NameCapPilot,NumCapPilots}

attackMap["Kad_ResourceFuelPod"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Kad_Swarmer"] = {"STATUS_Int_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kad_AssaultSwarmer"] = {"STATUS_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kad_AdvancedSwarmer"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kad_AdvancedAssaultSwarmer"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Kad_MultiBeamFrigate"] = {"STATUS_IonFrigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Kad_FuelPod"] = {"STATUS_SupportFrigate_Under_Attack", NameSupportPilot,NumSupportPilots}
attackMap["Kad_GuardianSpirit"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}

attackMap["Tai_ResourceController"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Tai_Interceptor"] = {"STATUS_Int_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tai_AttackBomber"] = {"STATUS_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tai_LightCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tai_HeavyCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tai_MultiGunCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tai_CommandCorvette"] = {"STATUS_COMMANDCorvette_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Tai_IonCannonFrigate"] = {"STATUS_IonFrigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Tai_SupportFrigate"] = {"STATUS_SupportFrigate_Under_Attack", NameSupportPilot,NumSupportPilots}
attackMap["Tai_Destroyer"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Tai_MissileDestroyer"] = {"STATUS_Destroyer_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Tai_HeavyCruiser"] = {"STATUS_Battlecruiser_Attack", NameCapPilot,NumCapPilots}

attackMap["Tur_Garbage"] = {"STATUS_ResourceControllerUnderAttack", NameSupportPilot, NumSupportPilots}
attackMap["Tur_Fighter"] = {"STATUS_Int_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_AttackBomber"] = {"STATUS_Bomb_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_StandardCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_MissileCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_TorpedoCorvette"] = {"STATUS_Corvette_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_MinelayerCorvette"] = {"STATUS_V_Minelayer_Under_Attack", NameFighterPilot, NumFighterPilots}
attackMap["Tur_IonArrayFrigate"] = {"STATUS_IonFrigate_Under_Attack", NameCapPilot,NumCapPilots}
attackMap["Tur_EnergyFrigate"] = {"STATUS_SupportFrigate_Under_Attack", NameSupportPilot,NumSupportPilots}
attackMap["Tur_HeavyCruiser"] = {"STATUS_Battlecruiser_Attack", NameCapPilot,NumCapPilots}
...
function StatusShipDestroyed(shipName, code)
	...
	if (genericshipnm=="ResourceController")or(genericshipnm=="ResourceRefinery")or(genericshipnm=="Garbage")or(genericshipnm=="RepairCarrier")or(genericshipnm=="ResourceFuelPod") then
		playSpeechActor("STATUS_MobileRefineryDies_1", raceHelper(),0, Frequency_Command)
	elseif(genericshipnm=="Destroyer")or(genericshipnm=="Destroyer1")or(genericshipnm=="MissileDestroyer")or(genericshipnm=="Guardianspirit") then
	...
	elseif(genericshipnm=="HeavyCruiser") then
		playSpeechActor("STATUS_HeavyCruiserDies_1", raceHelper(),0, Frequency_Command)
	...
	elseif(genericshipnm == "ResourceCollector")or(genericshipnm == "Salvager") then
...
function StatusTakingLightDamage(shipName, healthpercentage)
	...
	--familyName = getFamily(shipName)
	shipType = getType(shipName)
	shipnmU = strupper(shipName)
	-- checking shipName b/c family(Mothership) returns "CAPITAL"
	if (shipnmU == 'HGN_MOTHERSHIP' or shipnmU == 'VGR_MOTHERSHIP' or shipnmU == 'TUR_SHIPYARD' or shipnmU == 'TAI_MOTHERSHIP' or shipnmU == 'BEN_BENTUS' or shipnmU == 'KAD_MOTHERSHIP' or shipnmU == 'KAD_MOTHERSHIPLIGHT' or shipnmU == 'KAD_MOTHERSHIPDARK' or shipnmU == 'KPR_BALCORAGATE' or shipnmU == 'KUS_MOTHERSHIP') then
	...
	elseif (genericShipName=="ResourceController")or(genericShipName=="ResourceRefinery")or(genericShipName=="Garbage")or(genericShipName=="RepairCarrier")or(genericShipName=="ResourceFuelPod") then
		playSpeechActor("STATUS_ResourceControllerDamaged",NameSupportPilot, NumSupportPilots, Frequency_Command)
	elseif ((genericShipName == "ResourceCollector")and(Race_ID[currentRace] ~= "Kadesh")) or ((genericshipnm=="Salvager")and(Race_ID[currentRace] == "Kadesh")) then
...
function StatusDamaged(shipName)
	...
	if (genericShipName == "SupportFrigate")or(genericShipName == "FuelPod") then
	...
	elseif(strlower(genericShipName) == "battlecruiser")or(genericShipName == "HeavyCruiser")or(strlower(genericShipName) == "battleship") then
		playSpeechActor("STATUS_BattlecruiserDamaged_Report_1",NameCapPilot,NumCapPilots, Frequency_Command)
	elseif(genericShipName == "IonCannonFrigate")or(genericShipName == "IonArrayFrigate")or(genericShipName == "DestroyerFrigate")or(genericShipName == "MultiBeamFrigate") then
	...
	elseif ((genericShipName=="ResourceController")and(shipName~="Tur_ResourceController"))or(genericShipName=="ResourceRefinery")or(genericShipName=="Garbage")or(genericShipName=="RepairCarrier")or(genericShipName=="ResourceFuelPod") then
		playSpeechActor("STATUS_ResourceControllerDamaged",NameSupportPilot, NumSupportPilots, Frequency_Command)
--~ 		if (RAND_SWITCH==1) then
...
--~ 		end
	elseif (genericShipName == "ResourceCollector") or (genericshipnm=="Salvager") then
		playSpeechActor("STATUS_ResourceCollectorDamaged",NameSupportPilot, NumSupportPilots, Frequency_Command)
	...
	elseif (genericShipName == "Destroyer")or(genericShipName == "Destroyer1")or(genericShipName == "MissileDestroyer")or(genericShipName == "GuardianSpirit") then
	...
	elseif (shipName == "Vgr_InfiltratorFrigate")or(shipName == "Kad_MilitaryFuelPod") then
...
ssMap["Carrier"].MODULE_CLOAKGENERATOR = {"STATUS_CARRIER_CloakGeneratorUnderAttack_1","STATUS_CARRIER_CloakGeneratorDamaged_1","STATUS_CARRIER_CloakGeneratorDestroyed_1"}
...
ssMap["Carrier"].AC_HYPERSPACE = {"STATUS_CARRIER_HyperspaceCoreUnderAttack_1","STATUS_CARRIER_HyperspaceCoreDamaged_1","STATUS_CARRIER_HyperspaceCoreDestroyed_1"}
ssMap["Carrier"].C_HYPERSPACE = {"STATUS_CARRIER_HyperspaceCoreUnderAttack_1","STATUS_CARRIER_HyperspaceCoreDamaged_1","STATUS_CARRIER_HyperspaceCoreDestroyed_1"}
...
ssMap["Carrier"].C_PLATFORMCONTROL = {"STATUS_CARRIER_PlatformFacilityUnderAttack_1","STATUS_CARRIER_PlatformFacilityDamaged_1","STATUS_CARRIER_PlatformFacilityDestroyed_1"}
ssMap["Carrier"].AC_PLATFORMCONTROL = {"STATUS_CARRIER_PlatformFacilityUnderAttack_1","STATUS_CARRIER_PlatformFacilityDamaged_1","STATUS_CARRIER_PlatformFacilityDestroyed_1"}
...
ssMap["Carrier"].AC_CORVETTE = {"STATUS_CARRIER_CorvetteFacilityUnderAttack_1","STATUS_CARRIER_CorvetteFacilityDamaged_1","STATUS_CARRIER_CorvetteFacilityDestroyed_1"}
ssMap["Carrier"].C_CORVETTE = {"STATUS_CARRIER_CorvetteFacilityUnderAttack_1","STATUS_CARRIER_CorvetteFacilityDamaged_1","STATUS_CARRIER_CorvetteFacilityDestroyed_1"}
...
ssMap["Carrier"].AC_FIGHTER = {"STATUS_CARRIER_FighterFacilityUnderAttack_1","STATUS_CARRIER_FighterFacilityDamaged_1","STATUS_CARRIER_FighterFacilityDestroyed_1"}
ssMap["Carrier"].C_FIGHTER = {"STATUS_CARRIER_FighterFacilityUnderAttack_1","STATUS_CARRIER_FighterFacilityDamaged_1","STATUS_CARRIER_FighterFacilityDestroyed_1"}
...
ssMap["Carrier"].C_FRIGATE = {"STATUS_CARRIER_FrigateFacilityUnderAttack_1","STATUS_CARRIER_FrigateFacilityDamaged_1","STATUS_CARRIER_FrigateFacilityDestroyed_1"}
ssMap["Carrier"].AC_FRIGATE = {"STATUS_CARRIER_FrigateFacilityUnderAttack_1","STATUS_CARRIER_FrigateFacilityDamaged_1","STATUS_CARRIER_FrigateFacilityDestroyed_1"}
...
ssMap["Carrier"].C_MULTIBEAM = {"STATUS_CARRIER_MultiBeamModuleUnderAttack_1","STATUS_CARRIER_MultiBeamModuleDamaged_1","STATUS_CARRIER_MultiBeamModuleDestroyed_1"}
ssMap["Carrier"].C_MULTIBEAM_F = {"STATUS_CARRIER_MultiBeamModuleUnderAttack_1","STATUS_CARRIER_MultiBeamModuleDamaged_1","STATUS_CARRIER_MultiBeamModuleDestroyed_1"}
ssMap["Carrier"].C_SUPERSWARMER = {"STATUS_CARRIER_SuperSwarmerModuleUnderAttack_1","STATUS_CARRIER_SuperSwarmerModuleDamaged_1","STATUS_CARRIER_SuperSwarmerModuleDestroyed_1"}
ssMap["Carrier"].C_SUPERSWARMER_F = {"STATUS_CARRIER_SuperSwarmerModuleUnderAttack_1","STATUS_CARRIER_SuperSwarmerModuleDamaged_1","STATUS_CARRIER_SuperSwarmerModuleDestroyed_1"}
ssMap["Carrier"].C_LIQUIDMETAL = {"STATUS_CARRIER_LiquidMetalModuleUnderAttack_1","STATUS_CARRIER_LiquidMetalModuleDamaged_1","STATUS_CARRIER_LiquidMetalModuleDestroyed_1"}
ssMap["Carrier"].C_CLOAK = {"STATUS_CARRIER_EnergyCannonModuleUnderAttack_1","STATUS_CARRIER_EnergyCannonModuleDamaged_1","STATUS_CARRIER_EnergyCannonModuleDestroyed_1"}
...
ssMap["Shipyard"].AS_HYPERSPACE = {"STATUS_SHIPYARD_HyperspaceCoreUnderAttack_1","STATUS_SHIPYARD_HyperspaceCoreDamaged_1","STATUS_SHIPYARD_HyperspaceCoreDestroyed_1"}
...
ssMap["Shipyard"].AS_PLATFORMCONTROL = {"STATUS_SHIPYARD_PlatformFacilityUnderAttack_1","STATUS_SHIPYARD_PlatformFacilityDamaged_1","STATUS_SHIPYARD_PlatformFacilityDestroyed_1"}
...
ssMap["Shipyard"].AS_FIGHTER = {"STATUS_SHIPYARD_FighterFacilityUnderAttack_1","STATUS_SHIPYARD_FighterFacilityDamaged_1","STATUS_SHIPYARD_FighterFacilityDestroyed_1"}
ssMap["Shipyard"].AS_CORVETTE = {"STATUS_SHIPYARD_CorvetteFacilityUnderAttack_1","STATUS_SHIPYARD_CorvetteFacilityDamaged_1","STATUS_SHIPYARD_CorvetteFacilityDestroyed_1"}
...
ssMap["Shipyard"].AS_FRIGATE = {"STATUS_SHIPYARD_FrigateFacilityUnderAttack_1","STATUS_SHIPYARD_FrigateFacilityDamaged_1","STATUS_SHIPYARD_FrigateFacilityDestroyed_1"}
...
ssMap["MotherShip"].M_CAPSHIP = {"STATUS_Mothership_CapitalShipFacilityUnderAttack_1","STATUS_Mothership_CapitalShipFacilityDamaged_1","STATUS_Mothership_CapitalShipFacilityDestroyed_1"}
...
function StatusSubsystem(ssname, shipName, event)
	...
	--_ALERT("*****---- StatusSubsystem : ssname="..ssname..", shipName="..shipName..", event="..event)
	...
	if (ssMap[""..genericShipName] ~= nil) and (ssMap[""..genericShipName][""..genericssname] ~= nil and event ~= Repaired) then
		...
		elseif ((genericShipName == "Carrier")and(Race_ID[currentRace] ~= "Kadesh")) or genericShipName == "Battlecruiser" then
			playSpeechActor(ssMap[""..genericShipName][""..genericssname][event],  NameCapPilot,NumCapPilots, Frequency_Status)
		elseif (genericShipName == "MotherShip")or((genericShipName == "Carrier")and(Race_ID[currentRace] == "Kadesh")) then			
