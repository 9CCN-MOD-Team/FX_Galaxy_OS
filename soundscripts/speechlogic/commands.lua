...
function raceHelper()
	...
	elseif (Race_ID[currentRace] == "Taiidan")or(Race_ID[currentRace] == "Turanic")or(Race_ID[currentRace] == "Bentusi") then
		return NameEmperor
	elseif (Race_ID[currentRace] == "Kadesh") then
		return NameKadesh
...
--	end
	...
	if (familyName == "FRIGATE") then 
		return Frigate
	end
	
	if (familyName=="CAPTURER") then
		if (Race_ID[currentRace] == "Taiidan")or(Race_ID[currentRace] == "Keeper")or(Race_ID[currentRace] == "Kushan") then
			return Corvette
		elseif(shipnmU=="TUR_TORPEDOCORVETTE")then
			return Corvette
		elseif(shipnmU=="KAD_GUARDIANSPIRIT")then
			return Capital
		else
			return Frigate
		end
...
function CommandAttackGiven(shipname, targetname, attackType)
	...
	if (attackType == 3) then
		if (shipname=="Kpr_Dreadnaught") then
...
function CommandHotKeyGroupSelected(shipname, groupNumber, keyAction)
	...
	if (keyAction==ACT_Reinforced) then
		...
		if (groupNumber==10) then
			playSpeechActor("STATUS_HotkeyGroup_Added_10_2", raceHelper(), 0, Frequency_Command )
		else
...
function CommandShipsSelected(shipname)
	...
	if (shiptype == Flagship and shipname~="Kpr_Dreadnaught") then
...
sscMap["CARRIER"].C_FIGHTER = "STATUS_FighterFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].AC_FIGHTER = "STATUS_FighterFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_PRODUCTION_FIGHTER = "STATUS_FighterFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_CORVETTE = "STATUS_CorvetteFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].AC_CORVETTE = "STATUS_CorvetteFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_PRODUCTION_CORVETTE = "STATUS_CorvetteFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_LIQUIDMETAL = "status_liquidmetalmoduleconstructedfromkhartoba_1"
sscMap["CARRIER"].C_MULTIBEAM = "status_multibeammoduleconstructedfromkhartoba_1"
sscMap["CARRIER"].C_SUPERSWARMER = "status_superswarmermoduleconstructedfromkhartoba_1"
sscMap["CARRIER"].C_MULTIBEAM_F = "status_multibeammoduleconstructedfromkhartoba_1"
sscMap["CARRIER"].C_SUPERSWARMER_F = "status_superswarmermoduleconstructedfromkhartoba_1"
sscMap["CARRIER"].C_FRIGATE = "STATUS_FrigateFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].AC_FRIGATE = "STATUS_FrigateFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_PRODUCTION_FRIGATE = "STATUS_FrigateFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_PLATFORMCONTROL = "STATUS_PlatformFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].C_MODULE_PLATFORMCONTROL = "STATUS_PlatformFacilityConstructedFromCarrier_1"
sscMap["CARRIER"].AC_PLATFORMCONTROL = "STATUS_PlatformFacilityConstructedFromCarrier_1"
...
sscMap["CARRIER"].MODULE_CLOAKGENERATOR = "STATUS_CloakGeneratorConstructedFromCarrier_1"
...
sscMap["CARRIER"].AC_HYPERSPACE = "STATUS_HyperspaceCoreConstructedFromCarrier_1"
sscMap["CARRIER"].C_HYPERSPACE = "STATUS_HyperspaceCoreConstructedFromCarrier_1"
sscMap["CARRIER"].C_CLOAK = "status_energycannonmoduleconstructedfromkhartoba_1"
...
sscMap["SHIPYARD"].AS_FIGHTER = "STATUS_FighterFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].AS_CORVETTE = "STATUS_CorvetteFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].MS_PRODUCTION_FRIGATE = "STATUS_FrigateFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].AS_FRIGATE = "STATUS_FrigateFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].AS_FRIGATEADVANCED = "STATUS_AdvancedFrigateFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].MS_MODULE_PLATFORMCONTROL = "STATUS_PlatformFacilityConstructedFromShipyard_1"
sscMap["SHIPYARD"].AS_PLATFORMCONTROL = "STATUS_PlatformFacilityConstructedFromShipyard_1"
...
sscMap["SHIPYARD"].AS_HYPERSPACE = "STATUS_HyperspaceCoreConstructedFromShipyard_1"
sscMap["SHIPYARD"].MS_MODULE_FIRECONTROL = "STATUS_FireControlTowerConstructedFromShipyard_1"
sscMap["SHIPYARD"].AS_CAPSHIP = "STATUS_CapitalShipFacilityConstructedFromMothership_1"
sscMap["SHIPYARD"].AS_CAPSHIPADVANCED = "STATUS_AdvancedCapitalShipFacilityConstructedFromMothership_1"
sscMap["SHIPYARD"].MS_PRODUCTION_CAPSHIP = "STATUS_CapitalShipFacilityConstructedFromMothership_1"
...
sscMap["BATTLECRUISER"].HC_HYPERSPACE = "STATUS_HyperspaceCoreConstructedFromBattlecruiser_1"
...
sscMap["MOTHERSHIP"].M_CAPSHIP = "STATUS_CapitalShipFacilityConstructedFromMothership_1"
sscMap["MOTHERSHIP"].M_CAPSHIPADVANCED = "STATUS_AdvancedCapitalShipFacilityConstructedFromMothership_1"
...
--Kpr
stdCMap["Kpr_Mover1"] = "STATUS_MoverConstructed_1"
stdCMap["Kpr_Scout"] = "STATUS_ScoutConstructed"
stdCMap["Kpr_Bomber"] = "STATUS_AttackBomberConstructed"
stdCMap["Kpr_AssaultFrigate"] = "STATUS_AssaultFrigateConstructed"
stdCMap["Kpr_DestroyerFrigate"] = "STATUS_IonCannonFrigateConstructed"
stdCMap["Kpr_DefenseFieldFrigate"] = "STATUS_FieldFrigateConstructed"
stdCMap["Kpr_Destroyer1"] = "STATUS_DestroyerConstructed_1"
stdCMap["Kpr_Carrier"] = "STATUS_CarrierConstructed_1"
stdCMap["Kpr_ResourceCollector"] = "STATUS_ResourceCollectorConstructed_1"
stdCMap["Kpr_ResourceController"] = "STATUS_ResourceControllerConstructed"
stdCMap["Kpr_Energy_IonCannon"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_Energy_PhasedCannon"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_Energy_PhotonBomb"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_Energy_Photoncannon"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_Energy_Pulsar"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_Energy_SuperPulsar"] = "STATUS_ResearchShipConstructed"
stdCMap["Kpr_ProximitySensor"] = "STATUS_ProbeConstructed_1"
...
---STATUS_VAssaultCraftConstructed_1效果太违和了还是用status_vinterceptorconstructed_1吧
...
stdCMap["Kus_ResourceRefinery"] = "STATUS_ResourceControllerConstructed"
stdCMap["Kus_RepairCarrier"] = "STATUS_ResourceControllerConstructed"
...
-- Kadesh stuff
stdCMap["Kad_Swarmer"] = "STATUS_SwarmerConstructed"
stdCMap["Kad_AssaultSwarmer"] = "STATUS_AssaultSwarmerConstructed_1"
stdCMap["Kad_LanceSwarmer"] = "STATUS_LanceSwarmerConstructed_1"
stdCMap["Kad_AdvancedSwarmer"] = "STATUS_AdvancedSwarmerConstructed_1"
stdCMap["Kad_AdvancedAssaultSwarmer"] = "STATUS_AdvAssaultSwarmerConstructed_1"
stdCMap["Kad_VariationSwarmer"] = "STATUS_AberranceSwarmerConstructed_1"
stdCMap["Kad_FuelPod"] = "STATUS_SupportPodConstructed_1"
stdCMap["Kdd_MilitaryFuelPod"] = "STATUS_MarineFrigateConstructed_1"
stdCMap["Kad_MultiBeamFrigate"] = "STATUS_MultiBeamFrigateConstructed_1"
stdCMap["Kad_GuardianSpirit"] = "STATUS_NagualConstructed_1"
stdCMap["Kad_Carrier"] = "STATUS_CarrierConstructed_1"
stdCMap["Kad_Salvager"] = "STATUS_ResourceCollectorConstructed_1"
stdCMap["Kad_ResourceFuelPod"] = "STATUS_FuelPodConstructed_1"
stdCMap["Kad_Probe"] = "STATUS_ProbeConstructed_1"
stdCMap["Kad_GunTurret"] = "STATUS_DefenseGunConstructed_1"
stdCMap["Kad_Mothership"] = "STATUS_NebulaConstructed_1"
stdCMap["Kad_MothershipDark"] = "STATUS_DarkNebulaConstructed_1"
stdCMap["Kad_MothershipLight"] = "STATUS_BrightNebulaConstructed_1"
stdCMap["Kad_Araneid"] = "status_araneidconstructed_1"
-- Taiidan stuff
...
stdCMap["Tai_HeavyDefender"] = "STATUS_DefenderConstructed"
...
stdCMap["Tai_SalcapCorvette"] = "STATUS_SalvageCorvetteConstructed"
...
-- Turanic stuff
stdCMap["Tur_Scout"] = "STATUS_ScoutConstructed"
stdCMap["Tur_Fighter"] = "STATUS_InterceptorConstructed"
stdCMap["Tur_AttackBomber"] = "STATUS_AttackBomberConstructed"
stdCMap["Tur_MinelayerCorvette"] = "STATUS_MinelayerCorvetteConstructed_1"
stdCMap["Tur_AssaultFrigate"] = "STATUS_AssaultFrigateConstructed"
stdCMap["Tur_IonArrayFrigate"] = "STATUS_IonCannonFrigateConstructed"
stdCMap["Tur_EnergyFrigate"] = "STATUS_FieldFrigateConstructed"
stdCMap["Tur_Carrier"] = "STATUS_CarrierConstructed_1"
stdCMap["Tur_HeavyCruiser"] = "STATUS_HeavyCruiserConstructed"
stdCMap["Tur_ResourceCollector"] = "STATUS_ResourceCollectorConstructed_1"
stdCMap["Tur_Garbage"] = "STATUS_ResourceControllerConstructed"
stdCMap["Tur_CloakGenerator"] = "STATUS_CloakGeneratorConstructed"
...
function CommandConstructionComplete(buildingShip, builtItem, buildType)
	...
	--eliminate race
	genericbuildingShipName = strupper(strsub(buildingShip,5))
	genericbuiltItemName = strupper(strsub(builtItem,5))
	...
	if (buildType==BUILD_Subsystem) then
		...
		if (sscMap[""..genericbuildingShipName]~= nil and sscMap[""..genericbuildingShipName][""..genericbuiltItemName] ~= nil) then
			...
			elseif (genericbuildingShipName == "MOTHERSHIP")or((genericbuildingShipName == "CARRIER")and(Race_ID[currentRace] == "Kadesh")) then
